...
if DevAbs:get(SNAYBIR.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(SNAYBIR.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(SNAYBIR.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(SNAYBIR.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(SNAYBIR.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(SNAYBIR.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
SNAYBIRName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if SNAYBIRName then 
SNAYBIRNames = DevAbs:smembers(SNAYBIR.."Abs:Mute:Names"..msg.chat_id_) or ""
if SNAYBIRNames and SNAYBIRNames[1] then 
for i=1,#SNAYBIRNames do 
if SNAYBIRName:match("(.*)("..SNAYBIRNames[i]..")(.*)") then 
...
DevAbs:set(SNAYBIR.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(SNAYBIR.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
